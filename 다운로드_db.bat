...
echo ==================================================
echo Export dashboard memos from Firebase to Excel.
echo A new timestamped Excel file will be created.
echo ==================================================
"%PYTHON_EXE%" "%~dp0src\download_db.py"
...
if errorlevel 1 (
    ...
    echo.
    echo [DONE] Excel export completed.
)
pause
