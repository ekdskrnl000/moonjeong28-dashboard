    ...
    <div className="app-wrapper">
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .right-pane { display: none; flex: 1; height: 100vh; background: #0a0a0a; padding: 24px; flex-direction: column; }
        ...
        {selected ? (
          ...
          <>
            <header style={{ padding: "16px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                <p style={{ fontSize: 11, color: "#9CA3AF", fontWeight: 700 }}>송파구 문정동 28번지</p>
                <h1 style={{ fontSize: 20, fontWeight: 800, color: "#E8E6E1" }}>가로주택정비사업</h1>
              </div>
              <button onClick={syncInitialData} style={{ opacity: 0.1, fontSize: 10, color: "#fff" }}>SYNC</button>
            </header>
